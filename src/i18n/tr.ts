...
export const tr: Dict = {
  ...
  imageWorkbench: {
    ...
    preset: "Boyut ön ayarı",
    presetOriginal: "Özgün boyut",
    presetWeb: "Web · 1920 × 1080",
    presetEmail: "E-posta · 1280 × 1280",
    presetThumbnail: "Küçük resim · 512 × 512",
    presetCustom: "Özel",
    crop: "Ortadan kırp",
    cropNone: "Kırpma yok",
    cropSquare: "Kare · 1:1",
    cropFourThree: "Standart · 4:3",
    cropSixteenNine: "Geniş ekran · 16:9",
    rotation: "Döndür",
    rotateNone: "Döndürme yok",
    rotateRight: "90° sağa",
    rotateHalf: "180°",
    rotateLeft: "90° sola",
    ...
    note: "En-boy oranı korunur ve büyütme yapılmaz. Kırpma ortalanır. Yeniden kodlama gömülü meta verileri kaldırır; JPG şeffaflığı beyazla doldurur.",
    ...
    summary: (before: string, after: string) => `Toplam boyut: ${before} → ${after}`,
