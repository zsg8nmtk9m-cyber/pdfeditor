...
export const en = {
  ...
  imageWorkbench: {
    ...
    presetOriginal: "Original size",
    presetWeb: "Web · 1920 × 1080",
    presetEmail: "Email · 1280 × 1280",
    presetThumbnail: "Thumbnail · 512 × 512",
    presetCustom: "Custom",
    crop: "Center crop",
    cropNone: "No crop",
    cropSquare: "Square · 1:1",
    cropFourThree: "Standard · 4:3",
    cropSixteenNine: "Widescreen · 16:9",
    rotation: "Rotate",
    ...
    note: "Images keep their aspect ratio and are never enlarged. Crops are centered. Re-encoding removes embedded metadata; JPG output replaces transparency with white.",
    ...
    summary: (before: string, after: string) => `Batch size: ${before} → ${after}`,
