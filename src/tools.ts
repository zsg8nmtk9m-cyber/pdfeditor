...
export const TOOLS: ToolMeta[] = [
  ...
  { id: "rotate", path: "/rotate", icon: RotateCw, category: "Organize", accent: "bg-cyan-100 text-cyan-600", accepts: "application/pdf,.pdf" },
  { id: "compress", path: "/compress", icon: FileArchive, category: "Optimize", accent: "bg-emerald-100 text-emerald-600", accepts: "application/pdf,.pdf" },
  { id: "batch", path: "/batch", icon: Layers, category: "Optimize", accent: "bg-blue-100 text-blue-600", accepts: "application/pdf,.pdf", multi: true },
  ...
  { id: "page-numbers", path: "/page-numbers", icon: ListOrdered, category: "Edit", accent: "bg-fuchsia-100 text-fuchsia-600", accepts: "application/pdf,.pdf" },
  { id: "metadata", path: "/metadata", icon: FileCog, category: "Edit", accent: "bg-slate-200 text-slate-600", accepts: "application/pdf,.pdf" },
  { id: "redact", path: "/redact", icon: EyeOff, category: "Security", accent: "bg-slate-800 text-white", accepts: "application/pdf,.pdf" },
  { id: "protect", path: "/protect", icon: Lock, category: "Security", accent: "bg-red-100 text-red-600", accepts: "application/pdf,.pdf" },
  { id: "unlock", path: "/unlock", icon: Unlock, category: "Security", accent: "bg-teal-100 text-teal-600", accepts: "application/pdf,.pdf" },
];
